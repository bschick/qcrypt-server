...
export const publicKeyProd = "kVyD3JMfbqWSEe4XIzwxudJIyHMmID6lg69BQCGTcZk";
export const publicKeyDev = "0pbIB1B3k-oOTnMkq-41srsyiF18jms5HQKGiqS3f3c";

// ----- Helpers -----
export const sha256Hex = (buf: Buffer): string => crypto.createHash("sha256").update(buf).digest("hex");


export function getWebAuthnEmulator(): WebAuthnEmulator {
  ...
  return new WebAuthnEmulator(auth);
}
